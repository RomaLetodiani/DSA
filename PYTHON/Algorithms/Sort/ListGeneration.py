...
def listGenerator(size = 10000, min = -20000, max = 20000):
    ...
    Parameters:
        size (int): The size of the list to be generated. Default is 10000.
        min (int): The minimum value of the random integers to be generated. Default is -20000.
        max (int): The maximum value of the random integers to be generated. Default is 20000.
...
# Example usage
# Generates a list of 50000 numbers from -1000000 to 1000000
